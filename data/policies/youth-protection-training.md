...
# Youth Protection Training (Safety Youth Training)

_SYT (formerly YPT) requirements, training frequency, renewal timeline, and what the training covers. All registered adults must complete this._

> **Note:** BSA renamed Youth Protection Training to Safety Youth Training (SYT). All UI should display 'SYT'. DB columns retain legacy names.

[Home](https://www.scouting.org/) > [Training](https://www.scouting.org/training/) > Youth Protection
...
Scouting America has a multilayered adult leader selection process that includes criminal background checks administered by a nationally recognized third party and other screening efforts. Click [here](https://www.scouting.org/about/youth-safety/adult-leader-selection-process/) for information on the selection process.
...
* + **Safeguarding Youth training is required for all Scouting America registered volunteers and is a joining requirement.**
  ...
  + **Click below to take the training in English or Spanish**
    ...
    |  |  |
    | --- | --- |
    | **[English Language Version](https://my.scouting.org/vim2/webscript/output/proxy.aspx?method=ExecuteContainerAPI&container=LMSAgent&api=DeeplLink&Program=YPT)** | **[Spanish Language Version](https://my.scouting.org/vim2/webscript/output/proxy.aspx?method=ExecuteContainerAPI&container=LMSAgent&api=DeeplLink&Program=YPTSpanish)** |
...
4. Notify the Scout executive or his/her designee, if he/she cannot be reached call the 24/7 Scouts First Helpline at 1-844-726-8871 or email, [scoutsfirst@scouting.org](mailto:scoutsfirst@scouting.org)
...
[State Statutes on Child Welfare](https://www.childwelfare.gov/topics/systemwide/laws-policies/state/)
...
[Click here to download](https://filestore.scouting.org/filestore/pdf/680-676_WEB.pdf) the Youth Protection/Membership Infraction Incident Information Form.

[Click here](https://riskonnectbsa.my.salesforce-sites.com/) to directly enter the Youth Protection/Membership Infraction Incident online.
...
Although using social media is not a Scouting activity, their use to connect with others interested in Scouting can be a very positive experience. But the creation and maintenance of these channels requires forethought, care, and responsibility. [Read more about Scouting America Social Media Guidelines here](https://scoutingwire.org/social-media-guidelines/).
...
* [For Cub Scouts and their parents](https://filestore.scouting.org/filestore/pdf/100-014_WEB.pdf)
...
[Camp Leadership … A Guide for Camp Staff and Unit Leaders](https://www.scouting.org/wp-content/uploads/2019/09/623-12719-CampLeadershipBrochure_WEB.pdf)
...
[Camp Leadership – Youth Protection Begins With You Brochure](https://www.scouting.org/wp-content/uploads/2019/09/623-12719-CampLeadershipBrochure_WEB.pdf)
