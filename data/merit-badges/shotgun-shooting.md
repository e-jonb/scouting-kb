---
source: https://www.scouting.org/merit-badges/shotgun-shooting/
fetched: 2026-08-02
bsa_version: 2026.Q3
...
**NOTE:**  To enable safe and responsible learning and enjoyment of range and target activities, Scouting America has established rigorous standards for approved equipment and materials, ranges, qualified supervision, training, proper technique, and discipline. Details of the requirements and safe practices for activities in this merit badge may be found in the current Scouting America *Guide to Safe Scouting* and the *National Range and Target Activities Manual*.

The official merit badge pamphlets are now free and downloadable [HERE](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Pamphlets/Shotgun%20Shooting.pdf) or can be purchased at the [Scout Shop.](https://www.scoutshop.org/)
...
* (a)
  ...
  *Resource:* [High-Speed Collisions in Space - Experiments with a Carrot Gun (video)](https://youtu.be/kStpU1bU-oc&t=119)
* (b)
  Explain the basic rules of safe gun handling that apply to all firearms.
  *Resources:* [Rules of Gun Safety (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Shotgun%20Shooting/Rules%20of%20Gun%20Safety.pdf)
   [NRA Gun Safety Rules (website)](https://gunsafetyrules.nra.org/)
* (c)
...
* (1)
  ...
  *Resources:* [Parts of a Shotgun (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Shotgun%20Shooting/Parts%20of%20a%20Shotgun.pdf)
   [Parts of a Shotgun (photo)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Shotgun%20Shooting/parts_of_shotgun.png)
* (2)
  Identify and demonstrate the rules for safely storing and handling a shotgun.
  *Resource:* [Rules for Using or Storing a Gun (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Shotgun%20Shooting/Rules%20for%20Using%20or%20Storing%20a%20Gun.pdf)
* (3)
  Identify the parts of a shotgun shell and their functions.
  *Resources:* [Parts of a Shotgun Shell (PDF)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Shotgun%20Shooting/Parts%20of%20a%20Shotgun%20Shell.pdf)
   [Shot Size (photo)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Shotgun%20Shooting/shot_size.jpg)
   [Shotgun Ammunition (photo)](https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Shotgun%20Shooting/shotgun_ammunition.jpg)
* (4)
...
* (10)
  ...
  *Resource:* [The Muzzleloader Shotgun (video)](https://youtu.be/oAkZP_dXams)
* (11)
